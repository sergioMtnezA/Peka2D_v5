...
#define NVERT 3 		// Número de vértices de la celda

#define X_CELLS 1000 	// Número de celdas en la dirección X
#define Y_CELLS 100		// Número de celdas en la dirección Y
