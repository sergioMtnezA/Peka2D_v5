...
int read_peka_solini(t_mesh *mesh, char *filename){
...
int main (int argc, char * argv[]){
	...
	sprintf(filename,"%s.solini",argv[1]);
	read_peka_solini(mesh,filename);
